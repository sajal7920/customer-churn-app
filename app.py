...
st.markdown("<p style='text-align:center;'>Predict whether a customer will leave</p>", unsafe_allow_html=True)

st.markdown("---")

# -------- INPUTS -------- #
st.markdown("<div class='box'><b>👤 Customer Info</b></div>", unsafe_allow_html=True)
...
st.markdown("<div class='box'><b>💳 Billing</b></div>", unsafe_allow_html=True)
